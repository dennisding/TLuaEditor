...
#include "TLuaEditorInteractiveTool.generated.h"


/**
 * Builder for UTLuaEditorInteractiveTool
 */
UCLASS()
class TLUAEDITOR_API UTLuaEditorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UTLuaEditorInteractiveTool
 */
UCLASS(Transient)
class TLUAEDITOR_API UTLuaEditorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UTLuaEditorInteractiveToolProperties();
...
/**
 * UTLuaEditorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class TLUAEDITOR_API UTLuaEditorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UTLuaEditorInteractiveToolProperties> Properties;
