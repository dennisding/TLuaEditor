...
#include "TLuaEditorEditorMode.generated.h"
 ...
 */
UCLASS()
class UTLuaEditorEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_TLuaEditorEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UTLuaEditorEditorMode();
	virtual ~UTLuaEditorEditorMode();
